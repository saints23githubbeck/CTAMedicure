...
//   dd($order);
    ...
    public function accerpt(Order $order)
    {
        ...
        return redirect()->route('prescription.checkout.location',$order)->with('success', 'Success, Order Approved Successfully.');
    }
...
//
//
//        $addressFrom = auth()->user()->address()->first()->location;
//        $addressTo = $exact_location;
//
//// Get distance in km
//
