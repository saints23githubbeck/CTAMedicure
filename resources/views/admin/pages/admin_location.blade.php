...
@if (App\Models\admin_location::where('id',1)->exists())
<div class="card">
    <div class="card-body">
        ...
        <div class="my-5 mx-5">
            <div class="input-group">
                ...
                <input type="text" class="form-control" name="location" value="{{ App\Models\admin_location::find(1)->location_name }}" placeholder="Location" />
