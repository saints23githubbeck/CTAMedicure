                            ...
                            <div class="row my-3 ">
                                <div class="form-group col">
                                    ...
                                    <input type="text" name="from_date" class="form-control" id="from_date"
                                           placeholder=" Filter From" readonly/>
                                </div>
                                <div class="form-group col">
                                    To
                                    <input type="text" name="to_date" class="form-control" id="to_date"
                                           placeholder="Filter To" readonly/>
                                </div>
                                <div class="form-group col">


                                    <button type="button" id="filter" class="btn medibg text-white mt-4">Filter</button>
                                    <button type="button" id="refresh" class="btn medibg text-white mt-4">Refresh
                                    </button>
                            ...
                            <div class="row justify-content-end mb-3">
                                <div class="col-md-3 ">
                                    <button type="button" class="btn medibg custom-btn text-white"
                                            ...
                                            data-bs-target="#appointment">New Appointments
                                    </button>
                                </div>
                            </div>
                            @if(session('cannot'))
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @elseif($appointment->consultancyConfirm->status == 1 )
                                                 ...
                                                 <a href="" data-bs-toggle="modal"
                                                    data-bs-target="#preview-order-{{$appointment->id}}"><span
                                                             class="status text-white bg-info p-1 rounded shadow-lg">Confirmed</span></a>
                                              </span>
                                            ...
                                            <td>
                                                <a data-bs-toggle="modal"
                                                   data-bs-target="#update-appo-{{$appointment->id}}"
                                                   class="bg-success btn-sm text-white "><i
                                                            class="fas fa-edit"></i></a>
                                                <a class="bg-info btn-sm text-white" data-bs-toggle="modal"
                                                   data-bs-target="#details-appo-{{$appointment->id}}"><i
                                                            class="fas fa-eye"></i></a>
                                                <a class=" bg-danger btn-sm text-white " data-bs-toggle="modal"
                                                   data-bs-target="#delete-appo-{{$appointment->id}}"><i
    ...
    <script>
        ...
        $('#day').on('change', function () {
            ...
            $.ajax({
                type: 'POST',
                url: '/getDay',
                data: {day_name: day_name, user_id: user_id},
                success: function (data) {
                    $('#time').val(data);
